...
<head>
    ...
    <title>Delete Item-Inventory Management System</title>
    <style>
        body
        {
...
<body>
    ...
    <form method="POST">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "</select>";
            echo "<button name='delete' class='btn btn-dark'>Delete Product</button>";
        }
        else {echo "<b>No product is deleted!</b><br>";}
        ?>
    </form>
    </div></center>
    <?php
    if (isset($_POST['delete'])) {
        $sql1 = "DELETE FROM `inventory` WHERE `proName` = '$_POST[prname]'";
        $result1 = $conn->query($sql1);
        if ($result1 == TRUE) {
            echo "<br><b>Deleted Successfully !!</b>";
        } else {
            echo "<br><b>The product you want to delete is not exist!!</b>";
        }
    }
